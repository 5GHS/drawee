...
class _WritePageState extends ConsumerState<WritePostPage> {
  ...
  Widget build(BuildContext context) {
    final createPost = ref.watch(writePostViewModelProvider); // 상태 읽기
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            errorBorder: UnderlineInputBorder(
                              borderSide: BorderSide(
                                  color: AppColors.onError, width: 1.0),
                            ),
                          ...
                          onPressed: () async {
                            if (formKey.currentState?.validate() ?? false) {
                              ...
                              final newPost = Post(
                                ...
                                userId:
                                    'test_user', // Replace with actual user ID
                                title: titleValue,
                                imageUrl:
                              ...
                              final viewModel =
                                  ref.read(writePostViewModelProvider);

                              final success = await viewModel
                                  .createPost(newPost, image: _image);
